...
class DbaHomeFragment : Fragment() {
    ...
    private lateinit var matkulCardView: CardView
    ...
    private fun initComponents(view: View){
        ...
        matkulCardView = view.findViewById(R.id.matkulCardView)
    }
    ...
    private fun toMatkul(){
        matkulCardView.setOnClickListener{
            val newFragment = DbaMatkulFragment()
            parentFragmentManager.beginTransaction()
                .replace(R.id.fragment_container, newFragment)
                .addToBackStack(null)
                .commit()
