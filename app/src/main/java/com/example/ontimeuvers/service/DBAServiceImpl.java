...
import com.example.ontimeuvers.model.AddUsersMatkulError;
...
public class DBAServiceImpl implements DBAService{
    ...
    @Override
    public CompletableFuture<AddUsersMatkulError> addUsersMatkul(AddUsersMatkul request) {
        return matkulRepository.addUsersMatkul(request).thenApply(AddUsersMatkulError::new);
    }
}
